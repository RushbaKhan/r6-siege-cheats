...
const SITE_URL = 'https://r6siegecheats.com';
...
const staticRoutes = [
  ...
  { loc: `${SITE_URL}/esp`, lastmod: today, changefreq: 'weekly', priority: '0.95' },
  { loc: `${SITE_URL}/aimbot`, lastmod: today, changefreq: 'weekly', priority: '0.95' },
  { loc: `${SITE_URL}/wallhack`, lastmod: today, changefreq: 'weekly', priority: '0.95' },
  { loc: `${SITE_URL}/features`, lastmod: today, changefreq: 'weekly', priority: '0.9' },
  { loc: `${SITE_URL}/faq`, lastmod: today, changefreq: 'monthly', priority: '0.85' },
...
const blogRoutes = blogEntries.map(({ slug, lastmod }) => ({
  ...
  lastmod,
  changefreq: 'weekly',
  priority: slug.includes('guide') || slug.includes('explained') ? '0.9' : '0.85',
}));
