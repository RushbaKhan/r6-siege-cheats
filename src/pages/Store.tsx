...
const aimbotFeatures = [
  ...
  { label: 'R6 Triggerbot', desc: 'automatic firing on crosshair contact' },
  { label: 'R6 No Recoil', desc: 'weapon stability during sustained fire' },
];
  ...
  return (
    <>
      <section style={{
        ...
        <span className="section-label" style={{ marginBottom: '16px', justifyContent: 'center', display: 'flex' }}>Rainbow Six Siege Cheats</span>
        <h1 style={{
        ...
        <p style={{
          ...
          The ultimate undetected Rainbow Six Siege cheat. Aimbot, full ESP, wallhack, triggerbot, 2D radar, loot ESP, no recoil, and stream-proof mode. Updated after every patch.
        </p>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <h2 style={{
            ...
            marginBottom: '16px',
            textAlign: 'center',
          }}>See R6 Aimbot &amp; ESP in Action</h2>
          <p style={{
            fontFamily: 'var(--font-body)',
            fontSize: '0.95rem',
            color: 'var(--text-secondary)',
            ...
            maxWidth: '600px',
            margin: '0 auto 32px',
          }}>Watch our Rainbow Six Siege cheat featuring aimbot, ESP, triggerbot, and wallhack in real gameplay.</p>
          <div style={{
            ...
            <VideoEmbed
              src={VIDEO_HERO}
              ariaLabel="Rainbow Six Siege aimbot and ESP gameplay demonstration"
          ...
          <div style={{
            ...
            <div>
              <h2 style={{
                ...
                color: 'var(--text-primary)',
                marginBottom: '8px',
              }}>Rainbow Six Siege Cheats — Everything Included</h2>
              <p style={{
                fontFamily: 'var(--font-body)',
                fontSize: '0.875rem',
                color: 'var(--text-muted)',
                marginBottom: '24px',
              }}>One subscription covers every R6 cheat feature — aimbot, ESP, triggerbot, wallhack, radar, and loot ESP. No upsells, no tiers.</p>
              ...
              <div style={{
                ...
                <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '14px' }}>Rainbow Six Siege System Requirements</div>
                {[
                  ['Game', 'Rainbow Six Siege (Steam)'],
            ...
            <div style={{
              ...
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '16px' }}>Rainbow Six Siege Cheats Subscription</div>
              ...
              <div style={{
                ...
                Keep your R6 cheat updated after every patch. Enable spectator protection and stream-proof mode. Play smart to avoid manual reports.
              </div>
            </div>
          </div>
        </section>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <h2 style={{
            ...
            marginBottom: '16px',
            textAlign: 'center',
          }}>Rainbow Six Siege Screenshots</h2>
          <p style={{
            fontFamily: 'var(--font-body)',
            fontSize: '0.95rem',
            color: 'var(--text-secondary)',
            ...
            maxWidth: '600px',
            margin: '0 auto 32px',
          }}>Desert raids, trampler mechs, and extraction zones — the world where R6 cheats dominate.</p>
          <div style={{
            borderRadius: 'var(--radius-lg)',
            overflow: 'hidden',
            border: '1px solid var(--border-ghost)',
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 800, margin: '0 auto' }}>
            <h2 style={{
              ...
              color: 'var(--text-primary)',
              marginBottom: '16px',
            }}>Rainbow Six Siege Cheats FAQ</h2>
            <p style={{
              fontFamily: 'var(--font-body)',
              fontSize: '0.95rem',
              color: 'var(--text-secondary)',
              marginBottom: '40px',
            }}>Common questions about our R6 aimbot, ESP, triggerbot, wallhack, and radar.</p>
            <div>
