...
export const CUSTOMER_REVIEWS = [
  { name: 'Sway', quote: 'Support solved my R6 loader issue quick and easy. Fast response times every time — operator ESP and aimbot run great in ranked.', date: 'July 20, 2026' },
  { name: 'Joey Scalia', quote: 'Answered fast. Most reliable for answers and info on Rainbow Six Siege cheat setup. Great experience overall.', date: 'July 19, 2026' },
  ...
  { name: 'taj taj', quote: 'Support and the dev updates are the real deal. R6 cheat has been stable for me for weeks.', date: 'July 15, 2026' },
  ...
  { name: 'CQB_Gamer', quote: 'Very good support — they took their time and stayed until my Rainbow Six Siege issue was fully solved. Would use again.', date: 'July 12, 2026' },
];
...
function ReviewCard({ review, idx, visible }: { review: (typeof CUSTOMER_REVIEWS)[number]; idx: number; visible: boolean }) {
  return (
    <article className={`testimonials-review-card${visible ? ' testimonials-review-card--visible' : ''}`}>
  ...
  return (
    <>
      ...
      <p style={{
        ...
        Trusted by thousands of Rainbow Six Siege players worldwide. Real reviews from real players, unfiltered.
      </p>
    ...
    >
      <div className="testimonials-sticky" style={padX}>
        ...
        <div id="reviews-right" className="testimonials-stack-viewport">
          <div className="testimonials-stack-inner" style={{ height: `${stackHeight}px` }}>
