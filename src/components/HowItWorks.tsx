...
const steps = [
  {
    ...
    desc: 'Complete your purchase and get instant access. Your order page shows the loader download, setup instructions, and a video guide for Rainbow Six Siege cheats.',
    icon: (
  ...
  },
  {
    num: '03',
    title: 'Load & Play',
    desc: 'Open the loader, launch Rainbow Six Siege through Ubisoft Connect, and enable operator ESP, aimbot, and gadget ESP from the overlay. Ready for ranked or casual.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
