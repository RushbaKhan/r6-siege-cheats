      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', minWidth: 'min(100%, 240px)' }}>
            ...
            <p style={{
              ...
              Rainbow Six Siege cheats — operator ESP, aimbot, wallhack, gadget ESP, no recoil, and objective features for PC.
            </p>
          </div>
        ...
        <div style={{
          ...
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
            © 2026 {SITE_NAME}. Not affiliated with Ubisoft Entertainment.
          </span>
        </div>
      </div>
    </footer>
